...
const PRECACHE_ASSETS = [
  ...
  '/features/auth/signup.html',
  '/features/auth/confirm.html',
  '/features/products/dashboard.html',
  '/features/products/product.html',
  '/features/products/add_product.html',
  '/features/profile/profile.html',
  '/features/notifications/notifications.html',
  '/features/profile/menu.html',
  '/features/profile/settings.html',
  '/features/wishlist/wishlist.html',
  '/features/wishlist/add_wishlist.html',
  '/features/products/products.js',
  '/features/products/dashboard.js',
...
self.addEventListener('push', (event) => {
  ...
  event.waitUntil(
    self.registration.showNotification(data.title || 'Metups', {
      body:    data.body    || '',
      icon:    data.icon    || '/assets/icons/Metups_logo-192.png',
      badge:   data.badge   || '/assets/icons/Metups_logo-96.png',
